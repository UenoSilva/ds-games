...
import com.dsgames.projeto.dto.ReplecementDTO;
...
public class GameListController {
	...
	public void move(@PathVariable Long id, @RequestBody ReplecementDTO dto){
		gameListServiceImpl.move(id, dto.getSourceIndex(), dto.getDestinationIndex());
